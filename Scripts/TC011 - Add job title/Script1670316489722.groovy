...
WebUI.click(findTestObject('Object Repository/TC011/Page_OrangeHRM/a_Admin'))

WebUI.click(findTestObject('Object Repository/TC011/Page_OrangeHRM/i_Job_oxd-icon bi-chevron-down'))

WebUI.click(findTestObject('Object Repository/TC011/Page_OrangeHRM/li_Job Titles'))

WebUI.navigateToUrl('https://opensource-demo.orangehrmlive.com/web/index.php/admin/viewJobTitleList')

WebUI.click(findTestObject('Object Repository/TC011/Page_OrangeHRM/button_Add'))
