...
WebUI.setText(findTestObject('Object Repository/TC006/Page_OrangeHRM/input_Username_oxd-input oxd-input--focus'), 'putra')

WebUI.click(findTestObject('Object Repository/TC006/Page_OrangeHRM/button_Search'))

WebUI.verifyElementText(findTestObject('Object Repository/TC006/Page_OrangeHRM/div_No Records Found'), 'No Records Found')
